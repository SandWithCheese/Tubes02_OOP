...
// @Override
// public void save(String folderName, int currentTurn, Map<ProductCardModel,
// Integer> productList,
// PlayerModel player1, PlayerModel player2) {
// try {
// URL url = getClass().getResource("/com/if2210/app/gamestates/" + folderName);
// if (url == null || Paths.get("src/main/resources/com/if2210/app/gamestates",
// folderName) == null) {
...
// private void saveGameState(int currentTurn, Map<ProductCardModel, Integer>
// productList) {
// try {
...
// if (card != null) {
// FieldCardData cardData = new FieldCardData(fieldIndexToCode(new int[]{i, j}),
// card.getName());
...
// try {
// GameState gameState = xmlMapper.readValue(gameStatePath.toFile(),
// GameState.class);
...
// try {
// PlayerData playerData = xmlMapper.readValue(playerPath.toFile(),
// PlayerData.class);
...
// return new int[]{code.charAt(0) - 'A',
// Character.getNumericValue(code.charAt(1)) - 1};
// }
